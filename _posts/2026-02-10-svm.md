...
**Width of margin**: $\frac{2}{||\mathbf{w}||}$ (distance between the two parallel hyperplanes $\mathbf{w}^T\mathbf{x} + b = \pm 1$)
...
1. **$\text{\frac{1}{2}||\mathbf{w}||^2}$**: Maximize margin (minimize $||\mathbf{w}||$)
...
**Why $\text{||\mathbf{w}||^2$ instead of $||\mathbf{w}||}$?**

- $||\mathbf{w}||^2$ is differentiable everywhere
